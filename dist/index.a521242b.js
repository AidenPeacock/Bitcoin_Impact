...
var myChart = new (0, _autoDefault.default)(document.getElementById("acquisitions"), {
    ...
    data: {
        labels: [
            "Average Canadian household per month",
            "Driving 100,000km (24.2 gas mileage)",
            "10,000,000 visa transactions",
            "All ATM's in the world per day",
            "Bitcoin"
        ],
        datasets: [
            {
...
let labelstorage = [
    "average US citizens energy use during their life",
    "energy output of a coal power plant for 1 hour",
    "Netherlands energy useage per minute",
    "Burning 30 tonnes of coal",
    "Creation of 250 solar panels"
];
